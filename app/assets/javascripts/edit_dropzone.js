$(window).on("turbolinks:load", function() {
  ...
  // 画像を新しく追加する場合
  $("#edit_product .product__img__dropzone, #edit_product .product__img__dropzone2").on("change", 'input[type= "file"].upload-image', function() {
  ...
  // 削除ボタン
  $("#edit_product .product__img__dropzone, #edit_product .product__img__dropzone2").on('click', '.btn_delete', function() {
